...
Date:    Spring 2009
Purpose: This sample is similar to the circleMethods.java program from Chapter 7.  The difference is this
         program will just handle the Java Swing components to show a screen and handle click events.

         The calculations for the circle will be placed into its own class called circleCalculate so other
         people can use it too.

         For this to work you must place the circleCalculate.class into the same directory as this class.
*/
...
public class testNumerologySwing extends JFrame
{
    ...
    private class CalculateButtonHandler implements ActionListener
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        jtaOutput.append("Life Path Description: " + tstNum.getLifePathDescription() + "\n");
      }  // end actionPerformed
